...
def index(request):
    ...
    context = {"menu":menu, "title":"Главный страница", "posts":posts, "cats":cats, "cat_selected":0,}
...
def show_category(request, cat_id):
    ...
    if len(posts)==0:
        raise Http404
    context = {"menu": menu, "title": "Отображение по рубрикам", "posts": posts, "cats": cats, "cat_selected": cat_id, }
    return render(request, "women/index.html", context=context)
